...
**Google Drive** is the **primary cloud storage solution** at Singapore American School. All students and staff have unlimited storage and are strongly encouraged to use **Shared Drives** for team collaboration.
...
<CardGroup cols={2}>
  <Card title="Unlimited Storage" icon="infinity" color="#1A4190">
    **Never Run Out**

    Unlimited storage for all SAS users - store all your files without worry.
  </Card>
...
<Tabs>
  ...
  <Tab title="Google Drive for Desktop (Recommended)">
    **Sync Files to Computer:**
...
<Info>
  **SAS Benefit:** All students and staff have **unlimited Google Drive storage** - there's no need to worry about running out of space!
</Info>

**What this means:**
- Upload files of any size (up to 5TB per file)
- Store unlimited photos, videos, documents
- No quotas or limits
- Completely free for SAS users

**Compare to:**
- Personal Google accounts: 15GB free
- OneDrive (Office 365): 100GB
- iCloud free: 5GB
