...
<AccordionGroup>
  <Accordion title="SAS AI Resources" icon="school">
    - [AI Tools Overview](/guides/ai-resources/ai-tools-overview) - Compare AI tools
    - [Gemini Guide](/guides/ai-resources/gemini-guide) - How to use SAS's official AI
    - [AI Academic Integrity](/guides/ai-resources/ai-academic-integrity) - Rules and policies
